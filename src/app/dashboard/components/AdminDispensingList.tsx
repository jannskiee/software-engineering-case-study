            ...
            {queue.map((req: any) => (
                <Card key={req.id} className="overflow-hidden shadow-sm border-gray-200 animate-in fade-in duration-300">
                    <div className="px-4 py-3 bg-gray-50 border-b flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">ID: {req.student.schoolId}</p>
                            </div>
                        </div>
                    ...
                    <CardContent className="p-4 flex flex-col md:flex-row gap-6">
                                ...
                                <ul className="space-y-1">
                                    {req.items.map((i: any, idx: number) => (
                                        <li key={idx} className="flex justify-between items-center text-sm py-1 border-b border-gray-50 last:border-0">
                                            ...
                                            <span className="font-bold text-gray-900 bg-gray-100 px-2 py-0.5 rounded">x{i.quantity}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-3 justify-center min-w-[200px] border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                            <Button 
