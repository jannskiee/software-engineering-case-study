                ...
                <Card key={req.id} className="overflow-hidden shadow-sm border-amber-200 bg-amber-50/30 animate-in fade-in duration-300">
                    <div className="px-4 py-3 border-b flex justify-between items-center bg-white/50">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h4 className="text-sm font-semibold text-gray-900">{req.student.name}</h4>
                        ...
                        <span className="text-xs font-medium text-gray-500 bg-white px-2 py-1 rounded shadow-sm border">
                    ...
                    <CardContent className="p-4 flex flex-col md:flex-row gap-6">
                            ...
                            <div>
                                ...
                                <ul className="space-y-1">
                                    {req.items.map((i: any, idx: number) => (
                                        <li key={idx} className="flex justify-between items-center text-sm py-1 border-b border-gray-100/50 last:border-0">
                                            <span className="text-gray-700 flex items-center gap-2">
                                                <Package className="w-4 h-4 text-amber-500" />
                                                {i.item.name}
                                            </span>
                                            <span className="font-bold text-gray-900 bg-white shadow-sm border px-2 py-0.5 rounded">x{i.quantity}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                        ...
                        <div className="flex flex-col gap-3 justify-center min-w-[200px] border-t md:border-t-0 md:border-l border-amber-200/50 pt-4 md:pt-0 md:pl-6">
                            <Button 
