        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50/50 relative overflow-hidden">
            ...
            <Card className="w-full max-w-md z-10 shadow-2xl border-none">
                <CardHeader className="text-center space-y-2 pb-6">
                    ...
                    />
                    <CardTitle className="text-2xl font-bold tracking-tight text-dlsud-green">Welcome</CardTitle>
                ...
                <CardContent>
                    <div className="space-y-6">
                        ...
                        <Button
                            ...
                            disabled={loading}
                            className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 transition-colors h-12 flex items-center justify-center gap-3 shadow-sm"
                        >
                            {!loading ? (
                                <>
                                ...
                                <span className="font-semibold text-[15px] animate-pulse">Connecting to Google...</span>
                            )}
                        </Button>
                    </div>
                </CardContent>
